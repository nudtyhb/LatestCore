 ...
 *    Class:     ControlFlowAnalyser2
 *    Filename:  javaslicer-core/src/main/java/de/unisb/cs/st/javaslicer/controlflowanalysis/ControlFlowAnalyser2.java
 *
...
import de.unisb.cs.st.javaslicer.controlflowanalysis.ControlFlowGraph2.AbstractInstrNode;
import de.unisb.cs.st.javaslicer.controlflowanalysis.ControlFlowGraph2.InstrNode;
import de.unisb.cs.st.javaslicer.controlflowanalysis.ReachabilityNodeFactory2.ReachInstrNode;

public class ControlFlowAnalyser2 {

    private static ControlFlowAnalyser2 instance = new ControlFlowAnalyser2();

    private ControlFlowAnalyser2() {
        // private constructor
    }

    public static ControlFlowAnalyser2 getInstance() {
        return instance;
    }
    ...
    public Map<Instruction, Set<Instruction>> getInvControlDependences(ReadMethod method) {
        ...
        // 返回这个方法的控制流图
        ControlFlowGraph2 graph = new ControlFlowGraph2(method, ReachabilityNodeFactory2.getInstance());
        ...
        for (Instruction insn: method.getInstructions()) {
            ...
            ReachInstrNode reachNode = (ReachabilityNodeFactory2.ReachInstrNode)node; 
            // 当指令为LABEL节点时！
    ...
    public void computeReachableNodes(ControlFlowGraph2 cfg) {
