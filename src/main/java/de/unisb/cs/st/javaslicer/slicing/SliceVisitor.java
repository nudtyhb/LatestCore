...
public interface SliceVisitor {
	 ...
	 */
    void visitMatchedInstance(InstructionInstance instance);  //matched instance is the slicing criterion
     ...
     */
    // Variable is the current interesting variable!
    void visitSliceDependence(InstructionInstance from, InstructionInstance to,
    		Variable variable, int distance);  //  from is the source ,to is the destination
