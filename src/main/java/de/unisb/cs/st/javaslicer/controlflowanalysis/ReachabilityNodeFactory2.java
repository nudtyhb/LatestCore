...
import de.unisb.cs.st.javaslicer.controlflowanalysis.ControlFlowGraph2.AbstractNodeFactory;
import de.unisb.cs.st.javaslicer.controlflowanalysis.ControlFlowGraph2.InstrNode;

public class ReachabilityNodeFactory2 extends AbstractNodeFactory {

    public static class ReachInstrNode extends AbstractInstrNode {
        ...
        public ReachInstrNode(ControlFlowGraph2 cfg, Instruction instr) {
            super(cfg, instr);
    ...
    private static final ReachabilityNodeFactory2 instance = new ReachabilityNodeFactory2();

    private ReachabilityNodeFactory2() {
        // private ==> singleton
    }

    public static ReachabilityNodeFactory2 getInstance() {
        return instance;
    }
