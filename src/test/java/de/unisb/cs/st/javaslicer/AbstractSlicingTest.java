...
public abstract class AbstractSlicingTest {
    ...
    protected static ArrayList<InstructionInstance> getSlice(String traceFilename, String thread, String criterion)
        ...
        // SliceInstruction Collector implements the interface SliceVisitor
        ...
        Set<InstructionInstance> slice = new TreeSet<InstructionInstance>(collector.getDynamicSlice());
   ...
   /*     Iterator<InstructionInstance> sliceIt = slice.iterator();
...
*/
        return new ArrayList<InstructionInstance>(slice);
    }
